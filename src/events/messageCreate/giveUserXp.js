...
// import { calculateLevelXp, config } from '../../utils/logger.js';

// // const { mongoose: { mongoose.levelSchema } } = await getObjectModules("src/db", "mongoose", true);
...
//  */
// export default async (client, message, { mongoose }) => {
...
//         let level = await mongoose.levelSchema.findOne(query);
...
//             level = new mongoose.levelSchema({
